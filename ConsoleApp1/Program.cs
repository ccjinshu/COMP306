...
await DynamoDBHelper.InsertLabelDataAsync( bucketName,  fileKey,  "0.98");


//test
//await S3ImageProcessor.CreateAndUploadThumbnailToS3("ImageLabel", "ABC", "ImageLabel", 100, 100);
await S3ImageProcessor.CreateAndUploadThumbnailToS3(bucketName, fileKey, targetBucketName, 100, 100);
